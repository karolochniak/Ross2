...
class AddTwoIntsServerNode: public rclcpp::Node //zmien nazwe
{
    public:
    AddTwoIntsServerNode() : Node("add_two_ints_server") //zmien nazwe node
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Serwer dodawania dwóch liczb został uruchomiony");
    }
